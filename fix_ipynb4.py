...
for cell in nb['cells']:
    if cell['cell_type'] == 'code' and 'set_primary_key' in "".join(cell.get('source', [])):
        source = [
            ...
            "})\n",
            "\n",
            "# Cập nhật sdtype cho các cột cụ thể TRƯỚC khi set primary key\n",
            ...
            "\n",
            "# Cập nhật Primary Key SAU khi đã set sdtype là 'id'\n",
...
print("Notebook updated with correct order.")
